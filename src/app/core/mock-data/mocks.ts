...
export const categoriesMock: Category[] = [
    ...
    { id: 2, name: 'Beleza e Saúde', imageUrl: 'https://images.unsplash.com/photo-1556228578-567ba127e37f' },
    { id: 3, name: 'Acessórios', imageUrl: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f' },
    { id: 4, name: 'Escritório', imageUrl: 'https://images.unsplash.com/photo-1524678606370-a47ad25cb82a' },
    { id: 5, name: 'Esportes', imageUrl: 'https://images.unsplash.com/photo-1525904097878-94fb15835963' },
    { id: 6, name: 'Moda', imageUrl: 'https://images.unsplash.com/photo-1509695507497-903c140c43b0' },
];
...
export const proposalsMock: Proposal[] = [
  {
    id: 1,
    productOffered: productsMock.find(p => p.id === 3)!,
    productRequested: productsMock.find(p => p.id === 1)!,
    fromUser: usersMock.find(u => u.id === 3)!,
  ...
  {
    id: 2,
    productOffered: productsMock.find(p => p.id === 8)!,
    productRequested: productsMock.find(p => p.id === 2)!,
    fromUser: usersMock.find(u => u.id === 4)!,
  ...
  {
    id: 3,
    productOffered: productsMock.find(p => p.id === 5)!,
    productRequested: productsMock.find(p => p.id === 11)!,
    fromUser: usersMock.find(u => u.id === 1)!,
  ...
  {
    id: 4,
    productOffered: productsMock.find(p => p.id === 10)!,
    productRequested: productsMock.find(p => p.id === 4)!,
    fromUser: usersMock.find(u => u.id === 2)!,
